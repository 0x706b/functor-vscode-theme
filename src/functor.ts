...
const grass      =      "#90b290";
const beam       =      "#ffc888";
const orangepeel =      "#eb9b79";
const wildflower =      "#c0b3d8";
const pristine   =      "#a4cee7";
const light      =      "#e1bfab";
const moss       =      "#dbae9a";
...
const functorThemePath = path.join(process.cwd(), "/themes/functor-color-theme.json");
...
const functorTheme = {
  ...
  colors: {
    ...
    "editor.findMatchBackground": bg3,
    "editor.findMatchBorder": a(slate, "BB"),
    "editor.findMatchHighlightBackground": a(ocean, "99"),
    // "editor.findMatchHighlightBorder": a(slate, "BB"),
    "editor.findRangeHighlightBackground": a(ocean, "99"),
    ...
    "editorSuggestWidget.selectedBackground": darkgray,
    ...
    "terminal.ansiBrightYellow": orangepeel,
  ...
  semanticTokenColors: {
    "parameter.declaration": wildflower,
    "type.declaration": { "foreground": fg_, "fontStyle": "bold" },
    "parameter": fg0
  },
  tokenColors: [
  {
...
fs.writeFileSync(functorThemePath, JSON.stringify(functorTheme));
